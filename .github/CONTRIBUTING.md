...
git clone <https://github.com/hyperpolymath/palimpsest-plasma.git> cd
palimpsest-plasma
...
toolbox create palimpsest-plasma-dev toolbox enter palimpsest-plasma-dev
...
palimpsest-plasma/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \#
